...
if args.use_intense:
    save_path = os.path.join(
        current_dir, 'lightning_logs/Norman',
        f'Norman_Intense_reg_{str(args.intense_reg_rate).replace(".", "_")}_p_{args.intense_p}_seed_{args.seed}'
    )
else:
    save_path = os.path.join(current_dir, 'lightning_logs/Norman', f'Norman_Original_seed_{args.seed}')
...
if args.use_intense:
    ...
    trainer_params = {
        ...
        "mixup_alpha": 0.5,
        "lr": 0.00012440385669909188,
        "wd": 0.00000002614153801144,
        "adv_steps": 30,
        "reg_adv": 0.7450290313625371,
        "pen_adv": 2.761883326993846,
        "adv_lr": 0.006220085274007414,
        "adv_wd": 0.00000473231557828574,
        "doser_lr": 0.008954559214603563,
        "doser_wd": 0.00000002627419653983,
        "n_layers_adv": 5,
        "n_hidden_adv": 128,
...
results_dir = os.path.join(current_dir, 'lightning_logs/Norman', 'experiment_results')
